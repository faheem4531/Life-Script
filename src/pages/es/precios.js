...
const PricingPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Planes de Precios y Comparación con Competidores</title>
        <meta
          name="description"
          content="Cada paquete incluye acceso de por vida a nuestra plataforma, un libro de tapa dura premium a todo color y envío gratis."
        />
        <link rel="alternate" href="https://www.thelifescript.com/es/precios" hreflang="es" />
        <link rel="alternate" href="https://www.thelifescript.com/pricing" hreflang="en" />
        <link rel="canonical" href="https://www.thelifescript.com/es/precios" />
      </Head>
