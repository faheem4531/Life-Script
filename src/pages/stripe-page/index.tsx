    ...
    <>
      ...
      >
        <Box position={'relative'} zIndex={2}>
          ...
          <Box
            sx={{
              margin: { md: '100px 0 0 100px', sm: '100px 0 0 20px', xs: '60px 20px 0 ' },
              maxWidth: '600px',
            }}
          >
            <FormControl sx={{ display: showSecondForm ? 'none' : 'block' }}>
              <Typography sx={{ color: '#30422E', fontSize: '30px' }}>Who is LifeScript for?</Typography>
              <RadioGroup aria-labelledby="demo-radio-buttons-group-label" value={userType} onChange={(e) => setUserType(e.target.value)}>
                <Box
                  sx={{
