  ...
  return (
    ...
    >
      <Box sx={{ maxWidth: "510px" }}>
        ...
        >
          {t("aboutSection.ourStory.description")}
        </Typography>
        <Typography
          sx={{ fontSize: "16px", margin: "15px 0", fontFamily: "Avenir" }}
        >
          {t("aboutSection.ourStory.discription1")}
        </Typography>
        <Typography sx={{ fontSize: "16px", fontFamily: "Avenir" }}>
          {t("aboutSection.ourStory.discription2")}
        </Typography>
      </Box>
      <Image
        src={StoryImg}
